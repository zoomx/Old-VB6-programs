...
Dim i As Integer
    ...
    Next
    'Vede se il primo canale è programmato
    'Se lo è lo mostra
...
Public Sub CheckChan()
    Select Case Item
        Case 6
            Frame2.Visible = False
            Label5.Visible = False
            Label7.Visible = False
            tValMin.Visible = False
            tValoff.Visible = False
            Label6.Caption = "mm per count"
        Case 7
            Frame2.Visible = False
            Label5.Visible = False
            Label7.Visible = False
            tValMin.Visible = False
            tValoff.Visible = False
            Label6.Caption = "m/s per count"
        Case Else
            Frame2.Visible = True
            Label5.Visible = True
            Label7.Visible = True
            tValMin.Visible = True
            tValoff.Visible = True
            Label6.Caption = "Valore massimo"
    End Select
