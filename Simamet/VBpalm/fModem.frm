...
Private Sub Form_Load()
    ...
    Messaggio = sReadINI("Modem", "UltimaCom", FileIni)
    i = Int(Val(Messaggio))
    If i >= 1 And i <= 4 Then
        ComPort = i
    Else
...
Private Sub bChiama_Click()
    ...
    If Tempo0 = 0 Then
        ...
        Messaggio = Messaggio + "Simamet.ini"
        MsgBox Messaggio, vbOKOnly + vbCritical, "Simamet Errore!"
    End If
...
Private Sub Connetti()
    ...
    Dim i As Long
    Dim iSimamet As Integer
    Dim iMultipar As Integer
...
retry2:
    ...
    Risposta = UCase(InputComTimeOut(20))

    Debug.Print Risposta
    If Risposta = "" Then
        Messaggio = "Il modem ha risposto ma la centralina Simamet non risponde." + vbCrLf
...
'    fDebug = True
'    'Apre il file di log
'    Messaggio = sGetAppPath + "Log.txt"
'    fdn = FreeFile
'    If fDebug Then
'        Open Messaggio For Append As #fdn
'        Print #fdn, "Simamet"; Date; "*************************************"
'    End If
...
repeat:
    ...
    iSimamet = InStr(Stringa, "Simamet")
    If iSimamet <> 0 Then GoTo repeat

    If Stringa <> "TimeOut" Then
        If fDebug Then Print #fdn, "Bytes->"; Stringa
    ...
    Stringa = InputComTimeOut(5)
    If Stringa <> "TimeOut" Then
        If fDebug Then Print #fdn, "Volts->"; Stringa
    ...
    Stringa = InputComTimeOut(5)
    If Stringa <> "TimeOut" Then
        If fDebug Then Print #fdn, "Centralina->"; Stringa
...
Private Sub Timeout1()
    ...
    Mes = "Errore nella comunicazione" + vbCr + "la centralina Simamet non risponde!"
    MsgBox (Mes)
